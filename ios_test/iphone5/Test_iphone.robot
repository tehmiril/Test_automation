...
Login activity
    [Documentation]    Here we put pin and continue
    AppiumLibrary.Wait Until Element Is Visible    //*[@value="Email"]    20    None
...
Mobil activity
    [Documentation]    Here we select Mobil and continue
    AppiumLibrary.Click Element    //*[@name="MOBIL"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Tersedia"]    10    None
    AppiumLibrary.Click Element    //*[@name="Jabodetabek - Depok"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Lihat Berdasarkan"]    10    None
    AppiumLibrary.Click Element    //*[@name=" Jabodetabek"]
    AppiumLibrary.Click Element At Coordinates    255    20    #//XCUIElementTypeOther[@x="255"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Jabodetabek"]    10    None
    #AppiumLibrary.Click Element    //*[@name="PERMINTAAN"]
    #AppiumLibrary.Wait Until Element Is Visible    //*[@name="Baru"]    10    None
    #AppiumLibrary.Click Element    //*[@name="Disetujui"]
    AppiumLibrary.Click Element    //*[@name="PROFIL"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Profil"]    10    None
    AppiumLibrary.Click Element At Coordinates    275    35    #//XCUIElementTypeOther[@x="275" and @y="35"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@value="Email"]    20    None
...
Create complain
    ...
    AppiumLibrary.Click Element    //*[@name="Keluhan Saya"]
    ...
    AppiumLibrary.Click Element    //*[@name="BUAT KELUHAN"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Keluhan Baru"]    10    None
...
Logout activity_ASKA
    ...
    AppiumLibrary.Click Element At Coordinates    280    140
...
Return to main menu
    ...
    AppiumLibrary.Click Element At Coordinates    15    35
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Beranda"]    10    None
...
Check and create saham
    ...
    AppiumLibrary.Click Element    //*[@name="Tinjauan Kelompok"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Ringkasan"]    10    None
    ${sahamBegin}    Get Element Attribute    //XCUIElementTypeStaticText[@x="291" and @y="170"]    label
...
Create saham
    ...
    AppiumLibrary.Click Element    //*[@name="Buat Transaksi"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Jenis Transaksi"]    10    None
    AppiumLibrary.Click Element    //*[@name="Saham"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Transaksi Baru"]    10    None
    AppiumLibrary.Click Element At Coordinates    223    119
    #AppiumLibrary.Click Element    //*[@instance="13"]
    ${sahamA}    Get Element Attribute    //XCUIElementTypeStaticText[@x="254" and @y="119"]    label
    AppiumLibrary.Click Element At Coordinates    284    158
    ${sahamB}    Get Element Attribute    //XCUIElementTypeStaticText[@x="254" and @y="158"]    label
    ${sahamTotal}    Evaluate    ${sahamA}+${sahamB}
    ${sahamEnd}    Evaluate    ${sahamTotal}+${oldSaham}
    AppiumLibrary.Click Element    //*[@name="BUAT"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="OK"]    10    None
    AppiumLibrary.Click Element    //*[@name="OK"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Transaksi sukses dibuat"]    10    None
    AppiumLibrary.Click Element    //*[@name="OK"]
    AppiumLibrary.Click Element At Coordinates    15    35
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Beranda"]    10    None
    AppiumLibrary.Click Element    //*[@name="Tinjauan Kelompok"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Ringkasan"]    10    None
    ${sahamNew}    Get Element Attribute    //XCUIElementTypeStaticText[@x="291" and @y="170"]    label
...
Create dana sosial
    [Arguments]    ${oldDS}
    [Documentation]    Just checking if checkboxes are working
    AppiumLibrary.Click Element    //*[@name="Buat Transaksi"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Jenis Transaksi"]    10    None
    AppiumLibrary.Click Element    //*[@name="Dana sosial"]
    AppiumLibrary.Wait Until Element Is Visible    //*[@name="Dana Sosial"]    10    None
    AppiumLibrary.Click Element    //*[@name="Pilih semua"]
    AppiumLibrary.Click Element    //*[@name="Laras"]
    AppiumLibrary.Click Element At Coordinates    15    35
